...
// Generated: 2025-08-21T08:46:32.732Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Trusted by leading organizations for strategic advisory, digital transformation, and business analytics. 
                Helping clients achieve sustainable growth and competitive advantage.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">123 Main St, Suite 500</span>
              </div>
            </div>
