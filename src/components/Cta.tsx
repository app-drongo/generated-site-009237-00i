...
// Generated: 2025-08-21T08:46:33.084Z
// Section: cta
// Category: cta
...
import { ArrowRight, Briefcase, Users, Zap, ShieldCheck } from "lucide-react";

export default function CTAHome() {
  const stats = [
    { value: "10+", label: "Years of Experience", icon: Briefcase },
    { value: "95%", label: "Client Satisfaction", icon: Users },
    { value: "100+", label: "Successful Projects", icon: Zap },
    { value: "24/7", label: "Dedicated Support", icon: ShieldCheck },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                Elevate Your Consulting Firm's
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Unlock your firm's full potential with our comprehensive consulting
                services. Experience seamless digital transformation and drive
                sustainable growth.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Discover how we can transform your consulting firm
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Trusted by leading firms with enterprise-grade security
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Leverage our 10+ years of experience in the industry
              </p>
            </div>
          </div>
        </div>
